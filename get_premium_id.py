...
tier = sys.argv[1].lower() if len(sys.argv) > 1 else "premium"
...
for u in updates:
    print(u.get("update_id"), list(u.keys()))
...
if not updates:
    print(f"\nNo updates. Send a test message in your {tier.title()} channel, then run again.")
